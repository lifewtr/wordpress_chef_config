...
default['wordpress']['server_name'] ='chen.local'
...
default['wordpress']['server_admin'] ='chen.xu@hitachivantara.com'
...
default['wordpress']['wordpress_username'] = 'user '
# The default password for the WordPress database
default['wordpress']['wordpress_password'] = 'password'
